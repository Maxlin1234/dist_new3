...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_OnePageBlog = __nuxt_component_2;
      const _component_OnePageAbout = __nuxt_component_3;
      const _component_OnePageMarq = __nuxt_component_4;
      const _component_OnePageServices = __nuxt_component_5;
      const _component_OnePagePortfolio = __nuxt_component_6;
      const _component_OnePageIntro = __nuxt_component_7;
      const _component_OnePageTestimonials = __nuxt_component_8;
      const _component_OnePageImageSection = __nuxt_component_9;
      const _component_OnePageTeam = __nuxt_component_10;
...
//# sourceMappingURL=index-86333da6.mjs.map
